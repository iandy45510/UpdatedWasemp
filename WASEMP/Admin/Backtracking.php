        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="color: var(--bs-purple);background: var(--bs-dark);margin: 0px;padding-right: 0px;margin-right: 0px;margin-top: 0px;margin-bottom: 0px;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item">
                        <a class="nav-link" href=""><i class="fa fa-user"></i><span>Account</span></a>
                        <a class="nav-link" href=""><i class="fas fa-server"></i><span>List Of Server</span></a>
                        <a class="nav-link" href=""><i class="fas fa-chart-pie"></i><span>Analytics</span></a>
                        <a class="nav-link" href=""><i class="fas fa-qrcode"></i><span>QR</span></a>
                ...
                <footer class="footer-basic" style="background: var(--bs-dark);">
                    <div class="social" style="background: var(--bs-dark);padding-right: 0px;padding-top: 0px;margin-top: 0px;margin-bottom: 0px;margin-right: 0px;margin-left: 0px;font-size: 34px;">
                        <a href="https://www.instagram.com/kielmoreno92" style="background: var(--bs-white);border-color: var(--bs-dark);"><i class="icon ion-social-instagram"></i></a>
                        <a href="https://www.youtube.com/channel/UCc4RpGJxaIY0fFI27WhASug" style="background: var(--bs-white);"><i class="icon ion-social-youtube"></i></a>
                        <a href="https://www.facebook.com/SanExequielMorenoParish" style="background: var(--bs-white);"><i class="icon ion-social-facebook"></i>
                        </a>
                    </div>
                </footer>
